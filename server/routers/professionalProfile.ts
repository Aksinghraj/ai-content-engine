...
const profileInput = z.object({
  ...
  profileTheme: z.enum(["signal", "violet", "sunset", "mono"]).default("signal"),
  coverPreset: z.enum(["aurora", "violet-grid", "sunrise", "ocean", "paper", "midnight"]).default("aurora"),
...
const toDefaultProfile = (user: { name: string | null; email: string | null }) => ({
  ...
  profileTheme: "signal" as const,
  coverPreset: "aurora" as const,
  publicSlug: null,
  isPublic: false,
