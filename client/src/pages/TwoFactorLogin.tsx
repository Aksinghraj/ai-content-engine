...
export default function TwoFactorLogin() {
  ...
  const [trustedDeviceDays, setTrustedDeviceDays] = useState<1 | 7 | 30>(30);
  ...
  const verifyWithPasskey = async () => {
    try {
      ...
      await finishPasskey.mutateAsync({ response, trustedDeviceDays: trustThisDevice ? trustedDeviceDays : undefined });
    } catch (error) {
